...
- [x] SRSEngine: virtual time offset (get_time(), advance_debug_time()) for F5 accelerator
...
- [x] player.gd: F5 debug time toggle, HUD "TIME ACCEL" label
...
- [x] project.godot: debug_time input action (F5)
